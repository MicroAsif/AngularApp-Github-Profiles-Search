...
.valid-tooltip {
  ...
  line-height: 1;
  color: #fff;
  background-color: rgba(19, 185, 85, 0.8);
  border-radius: .2rem;
}
...
.invalid-tooltip {
  ...
  line-height: 1;
  color: #fff;
  background-color: rgba(252, 57, 57, 0.8);
  border-radius: .2rem;
}
...
.custom-select:focus {
  border-color: #593196;
  outline: 0;
  -webkit-box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(89, 49, 150, 0.25);
          box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 0 0.2rem rgba(89, 49, 150, 0.25);
}
...
.border {
  border: 1px solid #F9F8FC !important;
}
